// Aquí va todo tu código JavaScript
  let Clicker = new Audio("click.mp3");
  let Bomba = new Audio("bomba.mp3");
  let Ganaste = new Audio("ganaste.mp3");
  let Reiniciar = new Audio("pixel-level-up-sound-351836.mp3");
  let Perder = new Audio("videogame-death-sound-43894.mp3");
